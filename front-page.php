	...
	<div id="HomeHero" class="hero">
		<div class="orange-top">
			<div style="width: 1000px; margin: 0 auto; padding: 20px;">
				<img style="width: 50%" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/are-you-ready-for-more.svg" alt="Are You Ready For More">
			</div>
		</div>
		...
		<section class="panel">
			...
			<div>
				<img id="Smartphone" src="https://exodus90.com/wp-content/uploads/2018/12/ihpone-1.png" alt="Smartphone mockup">
			</div>							
		</div>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'primary' ); ?> role="main">
		...
		<section class="panel pad">
			<div class="grid-three-quarters ">
				...
				<div class="c">
					<img src="https://exodus90.com/wp-content/uploads/2018/12/app-download-e1545415665443.jpg" alt="Apple App Download Icons">
					<img src="https://exodus90.com/wp-content/uploads/2018/12/app-download-1-e1545415700558.jpg" alt="Google App Download Icons">
				</div>
			</div>
		</section>
